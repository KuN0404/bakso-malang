            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($sources as $source)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if($source->type === 'qris')
                                <span class="px-2.5 py-1 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-700 border border-indigo-200">
                                    QRIS (Scan QR)
                                </span>
                            @else
                                <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700 border border-green-200">
                                    {{ $source->name }} (Bayar Tunai)
                                </span>
                            @endif
                        </td>
